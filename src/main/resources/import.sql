...
INSERT INTO car (brand, brand_type, model, license_plate_number, consumption, cost_price, tco,  created_at, car_type, user_id)
...
INSERT INTO rental_plan (car_id, user_id, available_from, available_until, price, in_use, created_at)
...
INSERT INTO reservation (user_id, price, status, paid_at, created_at)
